...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        quotes= [' BELIEVING in YOURSELF is the first secret to SUCCESS.',
         ...
         ' HARD work beats talent when talent doesn\'t work hard. -Tim Notike',
         ...
         ' When you want to SUCCEED as bad as you want to BREATHE, than you\'ll be SUCCESSFUL. -Eric Thomas',
         ...
         ' I\'ve learned that people will forget what you said, people will forget what you did, but people will never forget how you MADE THEM FEEL. -Maya Angelov',
         ...
         ' Problems are not so stop signs, they are GUIDELINES. -Robert H. Schuller',
